...
class RiddleGenerator:
    ...
    def calculate_decent_riddles(self):
        ...
        for row in cursor:
            ...
            if difficulty > 0:
                ...
                self.decent_riddles.append({"riddle": unique_riddle, "difficulty": difficulty, "id": decent_riddle_counter})
    ...
    def get_decent_riddles_from_db(self):
        ...
        for i, decent_riddle in enumerate(decent_riddles):
            self.decent_riddles.append({"riddle": decent_riddle, "difficulty": difficulties[i], "id": i})
